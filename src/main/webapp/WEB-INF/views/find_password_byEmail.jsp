...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../resources/css/find_password_byEmail.css">
    ...
    <body>
        ...
        <div class="login-float-all">
            ...
            <div class="login-left">
                <div class="login-box">
                    <h2>忘记密码</h2>
                    <p class="h4-explain">请输入您的电子邮件，您将收到一封包含重置密码链接的邮件</p>
                    <form action="" method="post" onsubmit="return submitTestEmail()">
                        <div id="change_margin_4">
                            <input class="checkEmail" type="text" name="checkEmail" placeholder="电子邮箱地址" onblur="checkEmail()" onfocus="onFocus_3()">
                        </div>
                        <p id="remind_3"></p>

                        <div id="change_margin_3">
                            <input class="login-commit" type="submit" value="提交" >
                        </div>
