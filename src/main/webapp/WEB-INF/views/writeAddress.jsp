...
<div id="container" class="clearfix">
    ...
    <div class="container-address secend-container-address" id="writeAddress">
        ...
        <form action="" id="update-address" method="post">
            ...
            <div class="body">
                ...
                <div id="submit-btn">
                    <button type="submit" class="submit" name="save-address" id="submitbtn1">修改收货地址</button>
                    <button type="submit" class="submit" name="save-address" id="submitbtn2">新增收货地址</button>
                </div>
                <span id="msginfo">
                    <%
